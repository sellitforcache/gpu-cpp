...
void fission( unsigned , unsigned, unsigned, unsigned , unsigned*, unsigned* , unsigned* , unsigned*  , float * , unsigned* , float**);
...
void pop_source( unsigned, unsigned, unsigned, unsigned* , unsigned* , unsigned* , unsigned* , unsigned*, unsigned*, source_point* , float* , float* , float** );
