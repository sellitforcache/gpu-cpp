...
*/
	...
	const unsigned c   			= 1;						// constant add
	const unsigned prn_mod    	= 536870912;  				// 2^30
	const unsigned prn_mask   	= prn_mod - 1; 				// 2^30-1
	const float prn_norm   		= 1.862645149230957e-09;	// 2^-30
